...
from createASCfiles import createASC
...
#%% save original labfit file for referncing back to
...
#%% fit feature in each measurement and calculate required shifts


# load in the spectra

# isolate and fit the feature (likely want a list of features that are worth pursuing and corresponding wavelength range - bins?)
...
features = {62:[2188, 2192]}

# calculate the shift in all measurements

# update ASC files for that feature to be shift-free
